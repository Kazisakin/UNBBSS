...
exports.getSession = exports.getEventDetails = exports.submitNomination = exports.verifyOtp = exports.requestOtp = void 0;
...
const submitNomination = async (req, res) => {
    try {
        ...
        // Log security event
        (0, locationService_1.logSecurityEvent)('NOMINATION_SUBMITTED', clientIP, userAgent, {
        ...
        const withdrawalToken = crypto_1.default.randomBytes(32).toString('hex');
...
exports.submitNomination = submitNomination;
...
//# sourceMappingURL=nominationController.js.map